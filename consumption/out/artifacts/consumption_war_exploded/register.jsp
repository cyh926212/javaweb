...
<div class="container-fluid padding-top15" style="width:1200px">
    ...
    <div style="margin-right: auto;margin-left: auto;width: 30%;text-align: center;">
        <div class="animated fadeInRight" style="margin-right: auto;margin-left: auto;">
            <form action="user?action=register" method="post" id="loginForm" onsubmit="return dosubmit()">
                <h3 style="border-bottom:1px dashed #999;padding-bottom:10px;">用户注册</h3>
                <br>
                ...
                <p class="text-left">确认密码:<input type="password" name="repeatPassword" id="repeatPassword"/></p>
                <p class="text-left"></p>
                <button type="submit" class="button-grey animated fadeInUp">注册</button>
                已有账号？<a class="link-contact" href="index.jsp">去登录</a>
            </form>
        </div>
    </div>
</div>
